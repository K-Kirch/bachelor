...
class tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 438e6
        ...
        self.soapy_hackrf_sink_1 = soapy.sink(dev, "fc32", 1, '',
        ...
        self.soapy_hackrf_sink_1.set_gain(0, 'VGA', min(max(16, 0.0), 47.0))
        ...
        self.epy_block_1 = epy_block_1.blk(message=, rsc=)
        self.epy_block_0 = epy_block_0.blk(key=b'', iv=b'', mode=2, key_size=16, block_size=16, padding=b'\x00')
        self.digital_psk_mod_0 = digital.psk.psk_mod(
            ...
            verbose=False,
            log=False)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/kristian/Desktop/BachelorProject/msg.txt', True, 0, 0)
        ...
        self.connect((self.digital_psk_mod_0, 0), (self.soapy_hackrf_sink_1, 0))
        self.connect((self.epy_block_0, 0), (self.epy_block_1, 0))
        self.connect((self.epy_block_1, 0), (self.digital_psk_mod_0, 0))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, 100e3)
