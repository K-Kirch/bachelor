...
class signalSource(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Radio P3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Radio P3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "signalSource")
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.analog_wfm_rcv_0, 0))
...
def main(top_block_cls=signalSource, options=None):
