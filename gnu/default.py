...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = int(100000)
        self.center_freq = center_freq = 436e6
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/kristian/Desktop/transmission.bin', True, 0, 0)
